...
def main():
    parser = argparse.ArgumentParser(description='Shakelab: a tool for waveform downloading (fdsnws) and file conversion.')

    subparsers = parser.add_subparsers(dest='command', help='Choose a functionality')

    # Add subparser for fdsnws with detailed help
    fdsnws_parser = subparsers.add_parser('fdsnws', help='Download waveforms via FDSN.')
